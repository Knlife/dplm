...
@register_datamodule("tokenized_complex")
class TokenizedComplexDataModule(LightningDataModule):
    def __init__(
        self,
    ...
    def setup(self, stage: Optional[str] = None, split: Optional[str] = None):
        ...
        if stage == "fit":
            self.train_dataset = TokenizedComplexDataset(
            ...
            self.valid_dataset = TokenizedComplexDataset(
                data_dir=self.hparams.data_dir,
                csv_file=self.hparams.csv_file,
                vocab_file=self.hparams.vocab_file,
                split="valid",
            ...
            self.test_dataset = TokenizedComplexDataset(
                data_dir=self.hparams.data_dir,
                vocab_file=self.hparams.vocab_file,
